<template>
    <div class="minlist">
        <article class="indexhot">
            <h2><a href="/home/hot"><b v-if="movieList.length">正在上映({{movieList.length}}部)</b><i class="iconfont icon-youjiantou2"></i></a></h2>
            <ul class="clearfix">
                <router-link
        ...
        <article class="indexcoming">
            <h2><a href="/home/coming"><b v-if="comingmovie.length">即将上映({{comingmovie.length}}部)</b><i class="iconfont icon-youjiantou2"></i></a></h2>
        </article>
    </div>
</template>
